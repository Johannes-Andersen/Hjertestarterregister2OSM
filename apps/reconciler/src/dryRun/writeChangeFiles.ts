...
import type { ChangePlan, PlannedNode } from "./changePlan.ts";
...
const buildOsc = (changePlan: ChangePlan) => {
  const lines: string[] = [
    '<?xml version="1.0" encoding="UTF-8"?>',
    '<osmChange version="0.6" generator="hjertestarterregister2osm dry-run">',
    "  <create>",
  ];
...
export const writeDryRunChangeFiles = async ({
  changePlan,
  oscOutputPath,
  geojsonOutputPath,
